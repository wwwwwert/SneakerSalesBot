...
**ppps** я не понял как, но у меня уже на следующий день хостинга snatched токен, хотя единственное место, где я его указал - в команде запуска докера с env на сервере 
